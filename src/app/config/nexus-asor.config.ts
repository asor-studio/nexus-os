...
import {
    SystemStateCreateDataSet,
    AuthCreateDataSet,
    SystemStatusCreateDataSet,
...
export function initializeAsorCoreApp(stateService: StateService, mockOrchestratorService: MockOrchestratorService) {
    return () => {

        const levels: LogLevel[] = ["WARNING", "ERROR"];
        ...
        mockOrchestratorService.registryController(NexusMockAuthControllerService.className, inject(NexusMockAuthControllerService));
        ...
        stateService.createDataSet(
            SystemStateCreateDataSet.name,
            SystemStateCreateDataSet.data,
            SystemStateCreateDataSet.option!
        );
        stateService.createDataSet(
            AuthCreateDataSet.name,
            AuthCreateDataSet.data,
            AuthCreateDataSet.option!
        );
        stateService.createDataSet(
            SystemStatusCreateDataSet.name,
            SystemStatusCreateDataSet.data,
            SystemStatusCreateDataSet.option!
        );
